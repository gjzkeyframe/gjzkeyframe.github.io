...
![image](assets/resource/av-format-ts-1.jpg)
...
![image](assets/resource/av-format-ts-2.png)


![image](assets/resource/av-format-ts-3.png)
...
![image](assets/resource/av-format-ts-4.png)
...
![image](assets/resource/av-format-ts-8.jpg)

对于 PES 层数据结构的描述如下图所示：

![image](assets/resource/av-format-ts-5.png)

![image](assets/resource/av-format-ts-6.png)

![image](assets/resource/av-format-ts-7.png)
