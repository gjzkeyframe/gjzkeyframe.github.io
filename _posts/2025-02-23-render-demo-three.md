---
title: RenderDemo（5）：用 OpenGL 实现三分屏
description: 介绍用 OpenGL 实现三分屏的流程和原理，并提供 Demo 源码和解析。
author: Keyframe
date: 2025-02-23 13:48:08 +0800
categories: [音视频源码示例]
...
![三分屏处理图片效果](assets/resource/av-demo/render-demo-three.png)
_三分屏处理图片效果_
...
![三分屏效果对比](assets/resource/av-demo/render-demo-three-diff.gif)
_三分屏效果对比_
