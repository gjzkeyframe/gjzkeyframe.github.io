...
mermaid: false
image:
  path: assets/resource/aigc-prompt/aigc-prompt-2-1.jpeg
  alt: AIGC Image
---
...
![巴黎的超现实的球形全景](assets/resource/aigc-prompt/aigc-prompt-2-1.jpeg)
_巴黎的超现实的球形全景_

![罗马的超现实的球形全景](assets/resource/aigc-prompt/aigc-prompt-2-2.jpeg)
_罗马的超现实的球形全景_

![纽约的超现实的球形全景](assets/resource/aigc-prompt/aigc-prompt-2-3.jpeg)
_纽约的超现实的球形全景_

![迪拜的超现实的球形全景](assets/resource/aigc-prompt/aigc-prompt-2-4.jpeg)
_迪拜的超现实的球形全景_

![伦敦的超现实的球形全景](assets/resource/aigc-prompt/aigc-prompt-2-5.jpeg)
_伦敦的超现实的球形全景_

![马德里的超现实的球形全景](assets/resource/aigc-prompt/aigc-prompt-2-6.jpeg)
_马德里的超现实的球形全景_

![东京的超现实的球形全景](assets/resource/aigc-prompt/aigc-prompt-2-7.jpeg)
_东京的超现实的球形全景_
...
{%
  ...
  src='assets/resource/aigc-prompt/aigc-prompt-2-8.mp4'
  types='mp4'
  poster=''
  title='高质量的食物分层展示视频'
  autoplay=true
...
<!-- 
![高质量的食物展示视频](assets/resource/aigc-prompt/aigc-prompt-2-8.gif)
_高质量的食物展示视频_ 
-->
