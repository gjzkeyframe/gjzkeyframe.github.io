...
>![image](assets/resource/av-encode-audio-16.png)
...
>![image](assets/resource/av-encode-audio-17.png)
...
![image](assets/resource/av-encode-audio-6.png)
...
>![image](assets/resource/av-encode-audio-7.webp)

>![image](assets/resource/av-encode-audio-8.webp) 
-->
...
![image](assets/resource/av-encode-audio-2.png)


对应的 MPEG-2 AAC 的解码流程如图：

![image](assets/resource/av-encode-audio-3.png)
...
![image](assets/resource/av-encode-audio-11.png)
...
![image](assets/resource/av-encode-audio-12.png)
...
![image](assets/resource/av-encode-audio-9.png)

![image](assets/resource/av-encode-audio-10.png)


ADIF 格式的结构大体如下：

![image](assets/resource/av-encode-audio-14.png)


ADTS 格式的组成单元是 ADTS Frame。它的结构大体如下：

![image](assets/resource/av-encode-audio-13.png)



LOAS 格式的结构大体如下：

![image](assets/resource/av-encode-audio-15.png)
...
![alt](assets/resource/av-audio-presentation-14.png)
...
![频率混叠](assets/resource/av-audio-presentation-8.png)
...
![抗混叠滤波](assets/resource/av-audio-presentation-9.png)
