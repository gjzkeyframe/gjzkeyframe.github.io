...
上面是 `KFAudioCaptureViewController` 的实现，这里需要注意的是在采集音频前需要设置 [AVAudioSession](https://developer.apple.com/documentation/avfaudio/avaudiosession/ "AVAudioSession") 为正确的采集模式。
